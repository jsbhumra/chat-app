  ...
  return (
    <form onSubmit={handleMessSubmit} className='min-h-[45px] h-[45px] w-full shadow-[0_-15px_7.5px_-2px_#ccddff] shadow-[#ccddff] border-2 border-[#b2b2b2] rounded-full flex pl-5 z-[102]'>
        <div className='grow h-full'>
          <input type='text' placeholder='Enter your message here...' name="message" id="message" value={message} onChange={(e) => setMessage(e.target.value)} className='h-full w-full focus:outline-none bg-transparent' />
        </div>
